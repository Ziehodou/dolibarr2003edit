...
/**
 *  \file       core/modules/bonretour/doc/pdf_standard.modules.php
 *  \ingroup    bonretour
...
/**
 *	Class to manage PDF template standard_bonretour
 */
class pdf_standard_bonretour extends ModelePDFBonretour
{
	/**
	 ...
	 *
	 *  @param		Bonretour	$object				Object to generate
		...
		if (getMultidirOutput($object)) {
			...
			if (file_exists($dir)) {
				...
				for ($i = 0; $i < $nblines; $i++) {
					...
					$prev_progress =0 ; // $object->lines[$i]->get_prev_progress($object->id);
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Bonretour	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('BONRETOUR_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('BONRETOUR_DRAFT_WATERMARK')));
		}
