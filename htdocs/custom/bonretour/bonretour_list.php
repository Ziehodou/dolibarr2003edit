...
/**
 *   	\file       bonretour_list.php
 *		\ingroup    bonretour
 *		\brief      List page for bonretour
 */
...
require_once __DIR__.'/class/bonretour.class.php';
// for other modules
...
if ($enablepermissioncheck) {
	...
	$permissiontoadd = $user->hasRight('bonretour', 'bonretour', 'write');
	$permissiontodelete = $user->hasRight('bonretour', 'bonretour', 'delete');
} else {
	$permissiontoread = 1;
	$permissiontoadd = 1;
...
if (empty($reshook)) {
	...
	// Mass actions
	$objectclass = 'Bonretour';
	$objectlabel = 'Bonretour';
...
$title = $langs->trans("Bonretours");
//$help_url = "EN:Module_Bonretour|FR:Module_Bonretour_FR|ES:Módulo_Bonretour";
$help_url = '';
$morejs = array();
$morecss = array();
...
if ($num == 1 && getDolGlobalInt('MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE') && $search_all && !$page) {
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/bonretour/bonretour_card.php', 1).'?id='.((int) $id));
	exit;
}
...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/bonretour/bonretour_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);

print_barre_liste($title, $page, $_SERVER["PHP_SELF"], $param, $sortfield, $sortorder, $massactionbutton, $num, $nbtotalofrecords, 'object_'.$object->picto, 0, $newcardbutton, '', $limit, 0, 0, 1);

// Add code for pre mass action (confirmation or email presend form)
$topicmail = "SendBonretourRef";
$modelmail = "bonretour";
$objecttmp = new Bonretour($db);
